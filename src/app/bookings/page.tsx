...
import { getMyBookings, cancelBooking, type MyBooking, type BookingStatus } from '@/shared/api';
  ...
  return (
    <div className='bg-white rounded-2xl border border-[#E7E7EE] p-4 flex flex-col gap-3 shadow-sm'>
      <div className='flex items-start justify-between gap-2'>
        <div>
          <p className='text-sm font-semibold text-[#333] leading-snug'>
    ...
    <div className='max-w-2xl mx-auto px-4 py-6'>
      ...
      {!loading && !token && (
        <div className='flex flex-col items-center justify-center py-20 text-center'>
          ...
          <p className='mt-1 text-xs text-[#6B6B6B]'>Запишитесь к специалисту, чтобы войти в аккаунт</p>
          <Link
            href='/'
